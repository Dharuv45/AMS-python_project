...
cr.execute('''create table teacher(eid int , name varchar(32), email varchar(32), Password  varchar(32), gender varchar(32), courses varchar(32))''')
cr.execute('''create table attendance (rollno int , Date Date, Attendance varchar(32), marks int)''')
